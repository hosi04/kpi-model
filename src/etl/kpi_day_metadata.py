...
class KPIDayMetadataCalculator:    
    ...
    def calculate_uplift_from_historical(
        ...
        # Query historical theo 3 tháng gần nhất tính từ hiện tại (today() - INTERVAL 3 MONTH)
        historical_data = self.revenue_helper.get_historical_revenue_by_date_label_last_3_months(
    ...
    def calculate_metadata(
        ...
        # Lưu khoảng thời gian historical (mang tính mô tả), align với filter query: last 3 months tính từ today
        # Lưu ý: dùng 90 ngày như ước lượng cho "3 tháng"
        historical_end_date = date.today()
